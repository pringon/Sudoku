...
QT_MOC_LITERAL(4, 23, 6), // "column"
QT_MOC_LITERAL(5, 30, 11), // "resizeEvent"
QT_MOC_LITERAL(6, 42, 13), // "QResizeEvent*"
QT_MOC_LITERAL(7, 56, 5), // "event"
QT_MOC_LITERAL(8, 62, 15), // "mousePressEvent"
QT_MOC_LITERAL(9, 78, 12) // "QMouseEvent*"

    },
    "Cell\0valueChanged\0\0row\0column\0resizeEvent\0"
    "QResizeEvent*\0event\0mousePressEvent\0"
    "QMouseEvent*"
};
...
void Cell::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Cell::valueChanged)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void Cell::valueChanged(int _t1, int _t2)
{
